...
{
  spi_set_speed(SPI_BAUDRATEPRESCALER_32); /* 设置到低速模式 */
}
...
{
  spi_set_speed(SPI_BAUDRATEPRESCALER_8); /* 设置到高速模式 */
}
 ...
 * 比特率预定值,阶层III
 */
const uint16_t g_bitrate[2][16] = {{0, 8, 16, 24, 32, 40, 48, 56, 64, 80, 96, 112, 128, 144, 160, 0},
 ...
 * @retval      无
 */
void spi_set_speed(unsigned long speed)
{
